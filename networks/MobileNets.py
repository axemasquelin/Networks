...
class ConvBlocks(nn.Module):
    def __init__(self,kernel:int, chn_in:int, chn_out:int, stride:int=1,padding:int=0):
...
class MobileNetV2(nn.Module):
    def __init__(self, ch_in=3, n_classes=1000):
        ...
        self.last_conv = self.conv1x1(input_channel, 1280)
        ...
        return x 
    def conv1x1(self, chn_in:int, embeddim:int):
        """
        ...
        embeddim - int
            output size Embedding dimension out
        --------
        Returns:
        x - Tensor
            output of convolution tensor        
        """
